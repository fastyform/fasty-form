...
const SubmissionCardSkeleton = () => (
  <SubmissionCardContainer>
    ...
    <div className="w-full rounded-full bg-[#0D1116]">
      <h5 className="invisible select-none text-sm font-bold text-white lg:text-xl">Imię </h5>
    </div>
    <div className="w-full select-none rounded-full bg-yellow-400 py-[10px] text-center text-xs font-bold text-yellow-400 lg:text-base">
      Szczegóły
    </div>
  </SubmissionCardContainer>
);
