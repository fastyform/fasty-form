...
import actionCompleteUploadAndSendRequirements from '@/app/[locale]/(app)/(content)/submissions/[id]/requirements/_actions/action-complete-upload-and-send-requirements';
import actionGetUploadParts from '@/app/[locale]/(app)/(content)/submissions/[id]/requirements/_actions/action-get-upload-parts';
import { SubmissionRequirements } from '@/app/[locale]/(app)/(content)/submissions/[id]/requirements/utils';
