...
7. User Rights
   ...
   1. The user has the right to access their data, correct it, delete it (the right to be forgotten), and restrict its processing. The user can request the deletion of their account in the application through the contact form. This results in the permanent deletion of all their personal data.
